...
public class Validator {
     ...
     *
     * @returns restituisce la stringa ricevuta in input se rispetta il formato, lancia un'eccezione altrimenti
     **/
     ...
     *
     * @returns restituisce un oggetto LocalDate se la stringa rispetta il formato, lancia un'eccezione altrimenti
     **/
     ...
     *
     * @returns restituisce un intero se la stringa rispetta il formato, lancia un'eccezione altrimenti
     **/
     ...
     * @param integerValue stringa da validare
     *
     * @returns restituisce un double se la stringa rispetta il formato, lancia un'eccezione altrimenti
     **/
