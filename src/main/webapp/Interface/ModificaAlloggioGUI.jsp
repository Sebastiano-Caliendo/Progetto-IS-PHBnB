...
<div class="img-form">
    <div class="formInserisci small-text">
        ...
        <form action="<%= servlet %>modificaAlloggioServlet" method="post" enctype="multipart/form-data">
            ...
            <input type="submit" value="Modifica Alloggio" style="border : 2px solid var(--color-primary); width : 50%; height : 30px; color: black; background-color: var(--rosa-bianchissimo);">
        </form>
    </div>
    <div class="immagini">
